...
void MainObject::HandelInputAction(SDL_Event events, SDL_Renderer* screen)
{
    ...
    if (events.type == SDL_MOUSEBUTTONDOWN)
    {
        ...
        {
             Mix_Chunk* two_beep = Mix_LoadWAV(g_name_audio_bullet_main1);
            if (two_beep != NULL)
        Mix_PlayChannel(-1, two_beep, 0);
...
bool MainObject::CheckEndMap(Map& map_data){
    return x_pos_ == (MAX_MAP_X*TILE_SIZE - width_frame_-1);
}
